...
public class NewArrival extends Application{
    public static void main(String[] args) {
        launch(args);
    }
    
    public double arrival[] = {60,50,100};
    ...
    public void start(Stage primaryStage) throws Exception {
        ...
        Label title=new Label("New Arrival");
        title.setFont(Font.font("Courier New",FontWeight.BOLD, 20));
        title.setEffect(dropShadow);
        GridPane.setHalignment(title, HPos.CENTER);
        gdtop.add(title, 1, 0);
        
        Image allti = new Image("file:///E:/2nd year-1st semester/Software Development 2/images/kacchi.jpg",160,130,true,true);
        ImageView alltiv = new ImageView(allti);
        CheckBox allt = new CheckBox("Pran kacchi biryani redimix 60/pack BDT");
        ...
        Image tiffini = new Image("file:///E:/2nd year-1st semester/Software Development 2/images/faluda.jpg",160,130,true,true);
        ImageView tiffiniv = new ImageView(tiffini);
        CheckBox tiffin = new CheckBox("Falooda 50/pack BDT");
        ...
        Image funi = new Image("file:///E:/2nd year-1st semester/Software Development 2/images/dry cake.jpg",160,130,true,true);
        ImageView funiv = new ImageView(funi);
        CheckBox fun = new CheckBox("Danish Dry Cake 100/pack BDT");
        gdtop.add(funiv,0,3);
        gdtop.add(fun,1,3);
